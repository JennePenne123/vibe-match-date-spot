...
BEGIN
  ...
  -- Only allow in development/test environments (you can add additional checks here)
  ...
  INSERT INTO public.user_preferences (
    ...
    target_user_id,
    COALESCE(cuisines, ARRAY['Italian']::text[]),
    COALESCE(vibes, ARRAY['casual']::text[]),
    COALESCE(times, ARRAY['lunch']::text[]),
    COALESCE(price_range, ARRAY['$$']::text[]),

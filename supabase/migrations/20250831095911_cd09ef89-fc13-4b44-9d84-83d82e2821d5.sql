-- Fix the database trigger function to properly update both_preferences_complete
DROP TRIGGER IF EXISTS update_both_preferences_complete ON date_planning_sessions;
DROP FUNCTION IF EXISTS public.update_both_preferences_complete();

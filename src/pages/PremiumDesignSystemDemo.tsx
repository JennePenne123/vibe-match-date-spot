      ...
      <div className="border-b bg-background/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <Display size="lg" className="text-foreground">H!Outz Premium Design System</Display>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>H!Outz's existing color system</CardDescription>
                  </CardHeader>
          ...
          <TabsContent value="preview" className="space-y-8">
            <div>
              ...
              <Card className="bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20 shadow-[0_20px_50px_-10px_rgba(330,81%,60%,0.3)]">
                <CardHeader>
                  <CardTitle>Premium H!Outz Experience</CardTitle>

      ...
      <main className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center gap-2">
            ...
            <h1 className="text-3xl font-bold text-foreground">{t('aiRecommendations.title')}</h1>
          </div>
        ...
        <Card className="max-w-md mx-auto">
          <CardHeader className="pb-4">
            <CardTitle className="flex items-center gap-2 text-lg">
              ...
              {t('aiRecommendations.selectPartner')}
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <Select value={selectedPartnerId} onValueChange={setSelectedPartnerId}>
              <SelectTrigger>
                <SelectValue placeholder={t('aiRecommendations.choosePlaceholder')} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="">{t('aiRecommendations.soloRecommendations')}</SelectItem>
                {friends.map((friend) => (
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-center sm:text-left">
                <h2 className="text-2xl font-semibold text-foreground mb-1">
                  {t('aiRecommendations.recommendedVenues')}
                </h2>
                <p className="text-muted-foreground">
                  {t('aiRecommendations.venuesRanked', { count: recommendations.length })}
                </p>
              </div>
            ...
            {!hasHomeLocation && sortBy !== 'ai_score' && (
              <div className="text-sm text-muted-foreground bg-muted/50 rounded-md p-3 text-center">
                {t('aiRecommendations.setHomeHint')}
              </div>
            )}
          ...
          <Card className="max-w-md mx-auto text-center">
            <CardContent className="pt-6">
              ...
              <h3 className="text-lg font-medium text-foreground mb-2">
                {t('aiRecommendations.noRecommendations')}
              </h3>
              <p className="text-muted-foreground mb-4">
                {t('aiRecommendations.completePreferences')}
              </p>
              <Button onClick={refreshRecommendations}>
                {t('aiRecommendations.getRecommendations')}
              </Button>
            </CardContent>
          </Card>
        )}
